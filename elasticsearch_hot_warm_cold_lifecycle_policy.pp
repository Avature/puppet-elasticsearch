...
define elasticsearch::hot_warm_cold_lifecycle_policy (
  ...
  Optional[Integer]               $hot_priority,
  Optional[Integer]               $hot_rollover_max_size,
  Optional[Integer]               $hot_rollover_max_docs,
  Optional[Integer]               $hot_rollover_max_age,
  Optional[Integer]               $warm_min_age,
  Optional[Integer]               $warm_priority,
  Optional[Boolean]               $warm_unfollow,
  Optional[Integer]               $warm_allocate_number_of_replicas,
  Optional[Hash]                  $warm_allocate_include,
  Optional[Hash]                  $warm_allocate_exclude,
  Optional[Hash]                  $warm_allocate_require,
  Optional[Boolean]               $warm_read_only,
  Optional[Integer]               $warm_force_merge_max_num_segments,
  Optional[Integer]               $warm_shrink_number_of_shards,
  Optional[Integer]               $cold_min_age,
  Optional[Integer]               $cold_priority,
  Optional[Integer]               $cold_allocate_number_of_replicas,
  Optional[Hash]                  $cold_allocate_include,
  Optional[Hash]                  $cold_allocate_exclude,
  Optional[Hash]                  $cold_allocate_require,
  Optional[Boolean]               $cold_freeze,
  Optional[Boolean]               $cold_unfollow,
  Optional[Integer]               $delete_min_age,
  Optional[Boolean]               $delete_delete,
  ) {
