...
define elasticsearch::hot_warm_cold_lifecycle_policy (
  ...
  Optional[Integer]               $hot_priority                      = nil,
  Optional[Integer]               $hot_rollover_max_size             = nil,
  Optional[Integer]               $hot_rollover_max_docs             = nil,
  Optional[Integer]               $hot_rollover_max_age              = nil,
  Optional[Integer]               $warm_min_age                      = nil,
  Optional[Integer]               $warm_priority                     = nil,
  Optional[Boolean]               $warm_unfollow                     = nil,
  Optional[Integer]               $warm_allocate_number_of_replicas  = nil,
  Optional[Hash]                  $warm_allocate_include             = nil,
  Optional[Hash]                  $warm_allocate_exclude             = nil,
  Optional[Hash]                  $warm_allocate_require             = nil,
  Optional[Boolean]               $warm_read_only                    = nil,
  Optional[Integer]               $warm_force_merge_max_num_segments = nil,
  Optional[Integer]               $warm_shrink_number_of_shards      = nil,
  Optional[Integer]               $cold_min_age                      = nil,
  Optional[Integer]               $cold_priority                     = nil,
  Optional[Integer]               $cold_allocate_number_of_replicas  = nil,
  Optional[Hash]                  $cold_allocate_include             = nil,
  Optional[Hash]                  $cold_allocate_exclude             = nil,
  Optional[Hash]                  $cold_allocate_require             = nil,
  Optional[Boolean]               $cold_freeze                       = nil,
  Optional[Boolean]               $cold_unfollow                     = nil,
  Optional[Integer]               $delete_min_age                    = nil,
  Optional[Boolean]               $delete_delete                     = nil,
  ) {
